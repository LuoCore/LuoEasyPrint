namespace LuoEasyPrint
{
	...
	public partial class SimpleReportTextEdit : System.Windows.Forms.Form
	{
		// Token: 0x06001141 RID: 4417 RVA: 0x00089BB4 File Offset: 0x00087DB4
		...
		// Token: 0x06001142 RID: 4418 RVA: 0x00089BF4 File Offset: 0x00087DF4
		...
		private void InitializeComponent()
		{
			...
			size = new System.Drawing.Size(132, 230);
			...
			this.Label1.Text = "注1：内容中可以有纯文本及文本与系统变量、自定义变量、字段变量的任意组合，但请注意，在打印预览时，程序仅对系统变量、自定义变量、字段变量进行简单的替换操作。而不会进行表达式的计算操作，如果需要对表达式进行计算，请在设置该列时选中\"该列为计算列\"复选框。";
			...
			this.Label2.Text = "注2：如果不同类型的变量名称存在相同的情况 ，则替换变量的顺序是：先字段变量，再自定义变量，最后才是系统变量。";
			...
			this.Name = "SimpleReportTextEdit";
